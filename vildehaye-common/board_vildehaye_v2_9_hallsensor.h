#ifndef BOARD_VILDEHAYE_V2_6_H
#define BOARD_VILDEHAYE_V2_6_H
...
#define RESERVOIR_CAP_CONTROL IOID_0

#define HALLSENSOR            IOID_5
#define HALLSENSOR_ACTIVE     1
#define HALLSENSOR_INACTIVE   0
