#ifndef BOARD_CC1312_LAUNCHPAD_H
#define BOARD_CC1312_LAUNCHPAD_H

#include <ti/devices/cc13x2_cc26x2/driverlib/ioc.h>

/*
 *  IOID_30 is used to power the TCXO, if used (optional)
 *
 *  Otherwise seems almost identical to CC1350 launchpads.
 *
 *  CC1352 launchpads have a different pinout, may not be compatible with logger board.
 *
 */
