#ifndef BOARD_EBYTE_E72_H
#define BOARD_EBYTE_E72_H
...
#define RF_SWITCH_0       IOID_5 // 2.4GHz TX PA
#define RF_SWITCH_1       IOID_6 // 2.4GHz RX (and probably low-power TX)
